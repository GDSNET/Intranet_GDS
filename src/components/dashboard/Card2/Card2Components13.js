...
class Card2 extends Component {
   ...
   return data.map((data, i) => {
      ...
      <View style={styles.containerGrid}>
        ...
        <View style={styles.containerIndicador1}> 
            <Text  style={styles.txtGrid}>{data.valor1}</Text>
        </View>
        <View style={styles.containerIndicador1}> 
            <Text  style={styles.txtGrid}>{data.valor2}</Text>
        </View>
        <View style={styles.containerIndicador1}> 
            <Text  style={styles.txtGrid}>{data.valor3}</Text>
        </View>
        <View style={styles.containerIndicador1}> 
            <Rating
                            emptySymbol={<Text  style={styles.startempty}>⭑</Text>}
                            fullSymbol={<Text  style={styles.start}>⭑</Text>}
                            initialRating={data.valor4}
                            stop={5}
                            readonly
                        />
        </View>
  ...
  render() {
    const {titulo, icon, cab_attr1, cab_ind1, cab_ind2, cab_ind3, cab_ind4} = this.props;
    return (
          ...
          <View style={styles.containerDivisor}>
                ...
                <View style={styles.gridview}>
                      ...
                      <View style={styles.containerGrid_cabeza}>
                        ...
                        <View style={styles.containerIndicador1_cabeza}> 
                              <Text  style={styles.txtGridCabeza}>{cab_ind2}</Text>
                        </View>
                        <View style={styles.containerIndicador1_cabeza}> 
                              <Text  style={styles.txtGridCabeza}>{cab_ind3}</Text>
                        </View>
                        <View style={styles.containerIndicador1_cabeza}> 
                              <Text  style={styles.txtGridCabeza}>{cab_ind4}</Text>

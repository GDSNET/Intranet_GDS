...
import escena1 from '../../images/carousel/escena 5.png';
     ...
     <View style={styles.container}>
            ...
            <View style={styles_export.div_presentacion}>
                ...
                <View style={styles_export.divtitulo}>
                  ...
                  <Text style={styles_export.txt_titulo}>  INICIO DE PROMOCION</Text>
            
                </View>
                <View style={styles_export.divsubtexto}>

                
                <Textfit mode="multi" class="style_texfield"> Analisis Inicial de implementacion</Textfit>
                <Textfit mode="multi" class="style_texfield"> Se chequea control de stock</Textfit>
                <Textfit mode="multi" class="style_texfield">Reportes de cumplimientos </Textfit>
                <Textfit mode="multi" class="style_texfield">Se detalla los Locales que no cumplen</Textfit>
            
                </View>
                <View style={styles_export.divtexto}>

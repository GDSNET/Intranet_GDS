...
import escena1 from '../../images/carousel/escena 8.png';
     ...
     <View style={styles.container}>
            ...
            <View style={styles_export.div_presentacion}>
                ...
                <View style={styles_export.divtitulo}>
                  ...
                  <Text style={styles_export.txt_titulo}>  Reporte Final</Text>
            
                </View>
                <View style={styles_export.divsubtexto}>
                
                <Textfit mode="multi" class="style_texfield">Tableros Observacionales e Informacion en Linea con Herramientas Integrales.</Textfit>

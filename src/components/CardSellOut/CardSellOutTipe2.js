...
class CardSellOutTipe4 extends Component {
    ...
    return data.filter((item)=>{
      ...
      <View style={styles.containerGrid}>
          ...
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor2*100/ item.cantidad))>75?(<span className='icon_action_true_small'><Text className='icon_action_true_small' style={styles.txtGrid}>{Math.round(item.valor2*100/ item.cantidad)}%</Text></span>):(<span className='icon_action_false_small'><Text className='icon_action_false_small' style={styles.txtGrid}>{Math.round(item.valor2*100/ item.cantidad)}%</Text></span>)} </Text> 
              </View>
              <View style={styles.containerAtributo1Subtitulo}> 
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor2*100/ item.cantidad))>75?(<span className='icon_action_true_small'>&#8743;</span>):(<span className='icon_action_false_small'>&#8744;</span>)} </Text> 
              </View>
          </View>
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor3*100/ item.cantidad))>75?(<span className='icon_action_true_small'><Text className='icon_action_true_small' style={styles.txtGrid}>{Math.round(item.valor3*100/ item.cantidad)}%</Text></span>):(<span className='icon_action_false_small'><Text className='icon_action_false_small' style={styles.txtGrid}>{Math.round(item.valor3*100/ item.cantidad)}%</Text></span>)} </Text> 
              </View>
              <View style={styles.containerAtributo1Subtitulo}> 
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor3*100/ item.cantidad))>75?(<span className='icon_action_true_small'>&#8743;</span>):(<span className='icon_action_false_small'>&#8744;</span>)} </Text> 
              </View>
          </View>
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor4*100/ item.cantidad))>75?(<span className='icon_action_true_small'><Text className='icon_action_true_small' style={styles.txtGrid}>{Math.round(item.valor4*100/ item.cantidad)}%</Text></span>):(<span className='icon_action_false_small'><Text className='icon_action_false_small' style={styles.txtGrid}>{Math.round(item.valor4*100/ item.cantidad)}%</Text></span>)} </Text> 
              </View>
              <View style={styles.containerAtributo1Subtitulo}> 
              <Text  style={styles.txtsubGrid}>{(Math.round(item.valor4*100/ item.cantidad))>75?(<span className='icon_action_true_small'>&#8743;</span>):(<span className='icon_action_false_small'>&#8744;</span>)} </Text> 
              </View>
          </View>
      </View>
      )
  ...
  <View style={styles.containerGrid}>
          ...
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtAtributo1Titulo}> SELLOUT </Text> 
              </View>
          ...
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtAtributo1Titulo}> OSA </Text> 
              </View>
          ...
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtAtributo1Titulo}> INSTOCK </Text> 
              </View>
          ...
          <View style={styles.containerIndicador1}> 
              ...
              <Text  style={styles.txtAtributo1Titulo}> FILLRATE </Text> 
              </View>
